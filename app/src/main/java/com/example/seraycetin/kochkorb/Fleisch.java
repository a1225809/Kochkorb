 ...
 *  Quelle: http://stackoverflow.com/questions/1944656/android-global-variable
 */
public class Fleisch extends MainActivity implements View.OnClickListener {

    private Button btn_back;
    private Button btn_weiter;
    private String zufuegen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fleisch);
        ...
        for(String test:zutatenListe) Log.e("Log-Tag", test);
